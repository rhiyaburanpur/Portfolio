...
export function initDinoGame(outerContainerId) {
    ...
    */
    function Runner(outerContainerId, opt_config) {
        ...
        // Event handlers
        this.resizeHandler = this.debounceResize.bind(this);
    ...
    */
    ...
    Runner.prototype = {
        ...
        destroy: function () {
            ...
            window.removeEventListener(Runner.events.VISIBILITY, this.visibilityHandler);
            window.removeEventListener(Runner.events.BLUR, this.visibilityHandler);
            window.removeEventListener(Runner.events.FOCUS, this.visibilityHandler);
        ...
        init: function () {
            ...
            this.startListening();
            this.update();
            window.addEventListener(Runner.events.RESIZE, this.resizeHandler);
        },
        ...
        startGame: function () {
            ...
            this.playCount++;
            // window.addEventListener(Runner.events.VISIBILITY, this.visibilityHandler);
            // window.addEventListener(Runner.events.BLUR, this.visibilityHandler);
            // window.addEventListener(Runner.events.FOCUS, this.visibilityHandler);
        },
        ...
        update: function () {
            try {
                ...
                console.error('[DINO] Update loop error:', e);
            }
        },
        ...
        onKeyDown: function (e) {
            // Prevent default browser action (scrolling) for game keys
    ...
    Obstacle.types = [
        { type: 'CACTUS_SMALL', className: ' cactus cactus-small ', width: 17, height: 35, yPos: 105, multipleSpeed: 3, minGap: 120, collisionBoxes: [new CollisionBox(0, 7, 5, 27), new CollisionBox(4, 0, 6, 34), new CollisionBox(10, 4, 7, 14)] },
        { type: 'CACTUS_LARGE', className: ' cactus cactus-large ', width: 25, height: 50, yPos: 90, multipleSpeed: 6, minGap: 120, collisionBoxes: [new CollisionBox(0, 12, 7, 38), new CollisionBox(8, 0, 7, 49), new CollisionBox(13, 10, 10, 38)] }
    ];
    ...
    // START_GAME_LOGIC
    if (!Runner.instance_) {
        return new Runner(outerContainerId);
    }
    return Runner.instance_;
}
